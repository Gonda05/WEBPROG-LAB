...
$sortField = $_GET['sort'] ?? 'nik'; // default sort field
...
// Validate $sortField to prevent SQL injection (e.g., whitelist)
$allowedFields = ['nik', 'nama', 'gelar', 'lulusan', 'telp', 'user_input', 'tanggal_input'];
$whereClause = '';
...
$query = "SELECT * FROM dosen $whereClause ORDER BY $sortField $sortDir";
$result = mysqli_query($conn, $query);
?>

<!-- Trigger buttons -->
<h1 class="text-3xl font-semibold mb-2">Data Dosen</h1>
<div class="flex flex-wrap items-center justify-between gap-2">
    ...
    <button
        ...
        onclick="openModal({ title: 'Tambah Dosen', url: '/menu/dosen/tambah.php' })"
    >
        Tambah Dosen
    </button>
</div>
...
<?php
render_table($result, [
    'Edit' => 'javascript:void(0)" onclick="openModal({ title: \'Edit Dosen\', url: \'/menu/dosen/edit.php?nik={nik}\' })',
    'Hapus' => '/menu/dosen/hapus.php?nik={nik}'
]);
?>
